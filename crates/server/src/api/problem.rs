...
error_codes! {
    ...
    ConnectorInUse = ("connector_in_use", CONFLICT, "Devices or folders still use this connector"),
    ...
    CertificateRefused = ("certificate_refused", UNPROCESSABLE_ENTITY, "The certificate does not fit this host"),
    CaddyRefused = ("caddy_refused", UNPROCESSABLE_ENTITY, "Caddy refused the certificate and keeps the one before"),
    CaddyUnavailable = ("caddy_unavailable", SERVICE_UNAVAILABLE, "Caddy of the ops package is not reachable"),
